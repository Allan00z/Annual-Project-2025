            ...
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
                <div className="md:w-1/3 text-center md:text-left">
                    ...
                    <ul className="mt-2 space-y-1" style={{color: '#F6B99C'}}>
                        ...
                        <li><a href="/delivery" className="hover:text-orange-400">Livraison</a></li>
                ...
                <div className="md:w-1/3 text-center">
                    <Image src={Logo} alt="Audelweiss Logo" className="mx-auto w-40 mb-2"/>
                    <p className="text-sm" style={{color: '#D6D0C2'}}>
                    ...
                    <a href="https://www.instagram.com/audelweiss.craft/" target="_blank"
                       className="mt-4 inline-block text-gray-400 hover:text-white text-2xl me-2">
                    ...
                    <a href="https://www.tiktok.com/@audelweiss.craft" target="_blank"
                       className="mt-4 inline-block text-gray-400 hover:text-white text-2xl ms-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             viewBox="0 0 16 16">
                            <path
                ...
                <div className="md:w-1/3 text-center md:text-right">
                    ...
                    <ul className="mt-2 space-y-1" style={{color: '#F6B99C'}}>
                        ...
                        <li><a href="/privacy-policy" className="hover:text-orange-400">Politique de confidentialité</a>
                        </li>
                    </ul>
                </div>
            </div>
