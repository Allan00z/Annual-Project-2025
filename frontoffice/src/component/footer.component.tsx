    ...
    <footer className="bg-[#303028] text-white py-12 rounded-xl">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
        ...
        <div className="md:w-1/3 text-center">
          ...
          <a href="https://www.instagram.com/audelweiss.craft/" target="_blank" className="mt-4 inline-block text-gray-400 hover:text-white text-2xl me-2">
          ...
          <a href="https://www.tiktok.com/@audelweiss.craft" target="_blank" className="mt-4 inline-block text-gray-400 hover:text-white text-2xl ms-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
