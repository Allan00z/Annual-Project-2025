...
import pelote from "../medias/images/crochet-bg_files/newbonnet.png"

export default function HeroComponent() {
    return (
        <div className="hero grayscale-75 bg-base-200 h-100 rounded-xl" style={{backgroundImage: `url(${pelote.src})`}}>
            <div className="hero-content text-center">
                <div className="max-w-lg m-auto">
                    <h1 className="text-5xl font-bold text-white">Boutique</h1>
                    <p className="py-6 text-center font-bold text-white text-xl">Retrouvez tout nos produits</p>
